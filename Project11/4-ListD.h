...
Description: Creating a doubly linked list with dummy notes at head and tail
*/
...
class ListD
{
	public:
		...
		*/
		...
		/*
		pre: ListD exists
		post: All nodes containing item have been deleted.  Returns the number of nodes that have been deleted. 
		*/
		...
		/*
		pre: ListD exists.
		post: The item value of each node, from head to tail, is displayed on the screen, excluding the dummy nodes. 
		*/
		...
		/*
		pre: List exits.
		post: The item value of each node, from tail to head, is displayed on the screen, excluding dummy nodes.
		*/
		...
		/*
		pre:  List exists
		post: Nodes in the list are in ascending order.  The algorithm used to put nodes in order is selection sort. 
		*/
		
		void Sort();
   		
   		/*
		pre:  List has not yet been created
		post: List with head and tail has been created. Values for dummy nodes have been created. 
		*/

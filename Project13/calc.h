...
{ 
	...
	*/ 
	...
	/*
	pre:  invoked from constructor 
	post: 26 position valueTbl is dynamically allocated and filled with zeroes valueIdx is set to 0
	*/
	void MakeValueTbl(); 
	...
	*/ 
	...
	/* 
	pre:  invoked from constructor
	post: Using the stack technique discussed in class, returns true if parentheses are balanced, false 		otherwise
	*/
	bool CheckParens();

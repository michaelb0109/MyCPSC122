...
class List
{
	...
	*/
	...
	post: returns the position of item if item is in the list, -1 otherwise.  
	*/
	...
	Notice you've alread written a function to handle the case where n = 1. Make use of it here. 
	*/
